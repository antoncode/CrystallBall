...
- (void)viewDidLoad
{
    ...
    self.backgrounImageView.animationImages = [[NSArray alloc] initWithObjects:
    ...
    self.backgrounImageView.animationDuration = 2.5f;
    self.backgrounImageView.animationRepeatCount = 1;
}
...
- (void) makePrediction {
    [self.backgrounImageView startAnimating];
